...
//==============================================================================
QuetscherAudioProcessor::QuetscherAudioProcessor()
                       ...
                       ),m_algo(this), m_parameterVTS(nullptr)
{
    ...
    m_parameterVTS = std::make_unique<AudioProcessorValueTreeState>(*this, nullptr, Identifier("QuetscherVTS"),
...
//==============================================================================
const juce::String QuetscherAudioProcessor::getName() const
{
    return JucePlugin_Name;
}

bool QuetscherAudioProcessor::acceptsMidi() const
{
...
bool QuetscherAudioProcessor::producesMidi() const
{
...
bool QuetscherAudioProcessor::isMidiEffect() const
{
   #if JucePlugin_IsMidiEffect
    return true;
   #else
...
double QuetscherAudioProcessor::getTailLengthSeconds() const
{

    return 0.0;
}

int QuetscherAudioProcessor::getNumPrograms()
{
    return 1;   // NB: some hosts don't cope very well if you tell them there are 0 programs,
                // so this should be at least 1, even if you're not really implementing programs.
}

int QuetscherAudioProcessor::getCurrentProgram()
{
    return 0;
}

void QuetscherAudioProcessor::setCurrentProgram (int index)
{
    juce::ignoreUnused (index);
}

const juce::String QuetscherAudioProcessor::getProgramName (int index)
{
    juce::ignoreUnused (index);
    return {};
}

void QuetscherAudioProcessor::changeProgramName (int index, const juce::String& newName)
{
    juce::ignoreUnused (index, newName);
}

//==============================================================================
void QuetscherAudioProcessor::prepareToPlay (double sampleRate, int samplesPerBlock)
{
...
void QuetscherAudioProcessor::releaseResources()
{
    // When playback stops, you can use this as an opportunity to free up any
    // spare memory, etc.
}

bool QuetscherAudioProcessor::isBusesLayoutSupported (const BusesLayout& layouts) const
{
  #if JucePlugin_IsMidiEffect
...
void QuetscherAudioProcessor::processBlock (juce::AudioBuffer<float>& buffer,
...
//==============================================================================
bool QuetscherAudioProcessor::hasEditor() const
{
    return true; // (change this to false if you choose to not supply an editor)
}

juce::AudioProcessorEditor* QuetscherAudioProcessor::createEditor()
{
    return new QuetscherAudioProcessorEditor (*this);
}

//==============================================================================
void QuetscherAudioProcessor::getStateInformation (juce::MemoryBlock& destData)
{
...
void QuetscherAudioProcessor::setStateInformation (const void* data, int sizeInBytes)
{
...
{
    return new QuetscherAudioProcessor();
}
